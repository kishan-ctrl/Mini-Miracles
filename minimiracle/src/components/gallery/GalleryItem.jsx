...
const GalleryItem = React.memo(function GalleryItem({ item, onOpen, category }) {
  ...
  return (
    ...
    >
      {/* Placeholder block */}
      <div className={`w-full ${aspectClass} bg-gradient-to-br from-pink-200 via-purple-200 to-indigo-200`}>
        <div className="h-full w-full flex items-center justify-center">
          <span className="text-xs text-slate-700 px-3 text-center">{item.alt}</span>
        </div>
      </div>
